import { PUBLIC_SHOPIFY_STORE_URL,PUBLIC_SHOPIFY_STORE_TOKEN } from "$env/static/public"
...
export async function POST(query:string,variables:Object){    
    const API_URL = `${PUBLIC_SHOPIFY_STORE_URL}/api/2023-01/graphql.json`    
    ...
    fetchData['headers']["X-Shopify-Storefront-Access-Token"] = `${PUBLIC_SHOPIFY_STORE_TOKEN}`
