import { SHOPIFY_STORE_URL,SHOPIFY_STORE_TOKEN } from "$env/static/private"
...
export async function POST(query:string,variables:Object){    
    const API_URL = `${SHOPIFY_STORE_URL}/api/2023-01/graphql.json`    
    ...
    fetchData['headers']["X-Shopify-Storefront-Access-Token"] = `${SHOPIFY_STORE_TOKEN}`
